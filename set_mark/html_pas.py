            ...
            if(i_list[1] in ['div', 'span', 'embed', 'iframe']):
                if(re.search('<\/' + i_list[1] + '>', data)):
                    ...
                    if(src):
                        ...
                        if(v_src):
                            if(not v_src.groups()[0] in ["vimeo.com","trinket.io", "repl.it","www.youtube.com", "serviceapi.nmv.naver.com", "tv.kakao.com", "www.google.com", "serviceapi.rmcnmv.naver.com"]):
